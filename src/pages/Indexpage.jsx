  ...
  return (
    ...
    <div className='flex flex-wrap gap-y-7 w-full gap-6 p-4 px-2 '>
          ...
          <div className='mt-10 px-4 flex flex-col w-full'>
           ...
           <div className='min-w-[280px] max-w-[280px] shadow border-t hover:bg-slate-400 border-primary bg-slate-200 rounded flex flex-col items-center px-2'><div className='w-[260px] h-[220px] '><img src={dembare} className='w-full h-full' alt=''/></div><p className='mt-2 font-sans text-base'>Dynamos FC</p></div> 
           ...
           <div className='min-w-[280px] max-w-[280px] shadow border-t hover:bg-slate-400 border-primary bg-slate-200 rounded flex flex-col items-center px-2'><div className='w-[260px] h-[220px] '><img src={landers} className='w-full h-full' alt=''/></div><p className='mt-2 font-sans text-base'>Highlanders FC</p></div> 
            </div>
          </div>
          ...
          <div className='mt-10 mb-8 px-4 flex flex-col w-full'>
           ...
           <div className='min-w-[300px] max-w-[300px] shadow bg-slate-200 rounded flex flex-col items-center px-2'><div className='w-[260px] h-[220px] '><img src={zim} className='w-full h-full' alt=''/></div><p className='mt-2 font-sans text-base'>Castle Lager Premier Soccer League</p></div> 
           ...
           <div className='min-w-[300px] max-w-[300px] shadow bg-slate-200 rounded flex flex-col items-center px-2'><div className='w-[260px] h-[200px] '><img src={mbada} className='w-full h-full' alt=''/></div><p className='mt-2 font-sans text-base'>Mbada Diamond</p></div> 
            </div>
